...
<head>
    ...
    <title>SV Infra Developers - Building Trust, Shaping Dreams, Delivering Value</title>
    ...
    <meta name="author" content="SV Infra Developers">
    
    <!-- Open Graph Meta Tags -->
    <meta property="og:title" content="SV Infra Developers - Building Trust, Shaping Dreams, Delivering Value">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top shadow-sm" id="navbar">
        <div class="container">
            <a class="navbar-brand" href="#home">
                <img src="assets/images/logo.png" alt="SV Infra Developers" height="50" class="d-inline-block align-text-top">
                <span class="ms-2 fw-bold text-primary">SV Infra</span>
            </a>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    <p class="mb-0">&copy; 2025 SV Infra Developers. All rights reserved.</p>
                </div>
